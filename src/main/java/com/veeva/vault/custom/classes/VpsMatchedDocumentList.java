/*
 * --------------------------------------------------------------------
 * UDC:         VpsMatchedDocumentList
 * Author:      markarnold @ Veeva
 * Date:        2019-07-25
 *---------------------------------------------------------------------
 * Description: Matched Document List
 *---------------------------------------------------------------------
...
public class VpsMatchedDocumentList extends VpsBaseHelper {
	...
	public void loadFromDocumentVersion(List<String> versionIds) {
		...
		whereClause.append(VpsUtilHelper.listToString(versionIds,",",true));
		whereClause.append(")");
	...
	public void loadFromEdlItemList(List<String> edlItemtIds, Integer minimumMajorVersion) {
		...
		whereClause.append(VpsUtilHelper.listToString(edlItemtIds,",",true));
		whereClause.append(")");
