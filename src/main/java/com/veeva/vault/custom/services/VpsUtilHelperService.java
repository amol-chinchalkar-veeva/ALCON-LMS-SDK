/*
 * --------------------------------------------------------------------
 * UserDefinedService:	VpsUtilHelper
...
public interface VpsUtilHelperService extends UserDefinedService {
	...
	public static boolean hasValueChanged(Record oldRecord, Record newRecord, String fieldName, String fieldType, boolean firstTimeSet)
	{
		boolean changed = false;
		if (fieldType.equalsIgnoreCase("string"))
		{
			String oldValue = oldRecord.getValue(fieldName, ValueType.STRING);
			String newValue = newRecord.getValue(fieldName, ValueType.STRING);
			if (oldValue != null)
			{
				if (newValue != null)
				{
		...
		{
			LocalDate oldValue = oldRecord.getValue(fieldName, ValueType.DATE);
			LocalDate newValue = newRecord.getValue(fieldName, ValueType.DATE);
			if (oldValue != null)
			{
				if (newValue != null)
				{
